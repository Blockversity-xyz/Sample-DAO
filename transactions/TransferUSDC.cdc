    ...
    transaction {
      ...
      prepare(acct: AuthAccount) {
        ...
        let vaultRef = acct.borrow<&FiatToken.Vault>(from: /storage/FVaultStoragePath)
      ...
      execute {
        ...
        let recipient = getAccount(0x6ecbbe5a6529c1bb)
        log("Recipient: 0x6ecbbe5a6529c1bb")
        // Get the recipient's Receiver reference to their Vault
        // This is the interface that lets them receive tokens sent to them
        // by borrowing the reference from the public capability
        let receiverRef = recipient.getCapability(/public/FVaultReceiverPubPath)
